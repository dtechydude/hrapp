    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=["company", "name"],
                name="unique_company_salary_structure",
            )
        ]
...
class SalaryStructureItem(models.Model):
    ...
    formula_override = models.CharField(
        max_length=255,
        blank=True,
        help_text="Optional custom formula for this structure.",
    )
